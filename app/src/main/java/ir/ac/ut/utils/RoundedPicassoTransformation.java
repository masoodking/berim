...
/**
 * Created by Masood on 7/13/15.
 */
public class RoundedPicassoTransformation implements Transformation {

    private final int radius;

    private final int margin;

    public RoundedPicassoTransformation(final int radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
    }
